...
humandate: "April 23, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
helper: ["Joel Dunstan","Josh Williams","Keegan Smith"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<strong>What do I need to do before attending?</strong> <br>
  ...
  <ol>
    <li> Installed Bash </li>
    <li> Installed Git </li>
    <li> Created a <a href="https://github.com/">GitHub</a> account </li>
  </ol>
